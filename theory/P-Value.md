...
If $Z = 2$: You look at a Z-table (or use a function) to find the area in the "tail" of the curve. That area is $\approx 0.0228$ $\imples$ Translation: There is a $2.28\%$ probability of seeing a price move this extreme (or more extreme) by pure random chance.
